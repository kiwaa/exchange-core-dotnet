...
//            // check balances
//            Task<SingleUserReportResult> report1 = api.processReport<SingleUserReportQuery, SingleUserReportResult>(new SingleUserReportQuery(301), 0);
//            Console.WriteLine("SingleUserReportQuery 1 accounts: " + report1.Result.getAccounts());

//            Task<SingleUserReportResult> report2 = api.processReport<SingleUserReportQuery, SingleUserReportResult>(new SingleUserReportQuery(302), 0);
//            Console.WriteLine("SingleUserReportQuery 2 accounts: " + report2.Result.getAccounts());
...
//            Task<TotalCurrencyBalanceReportResult> totalsReport = api.processReport<TotalCurrencyBalanceReportQuery, TotalCurrencyBalanceReportResult>(new TotalCurrencyBalanceReportQuery(), 0);
//            Console.WriteLine("LTC fees collected: " + totalsReport.Result.getFees()[currencyCodeLtc]);
